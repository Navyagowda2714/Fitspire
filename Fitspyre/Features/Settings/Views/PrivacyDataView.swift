...
struct PrivacyDataView: View {
    ...
    var body: some View {
        NavigationStack {
            List {
                Section {
                    Text("Fitspyre stores all your data on this device only. Nothing is sent to any server unless you enable iCloud sync, which stores data only in your personal Apple iCloud account.")
                        .font(.system(size: 14))
                ...
                Section {
                    DataRow(
                        ...
                        label: "No ads",
                        detail: "Fitspyre never shows advertisements"
                    )
                    DataRow(
