...
struct HomeExerciseDemoView: View {
    ...
    var body: some View {
        ZStack(alignment: .top) {
            ...
            // ── Single scroll: everything scrolls together ────────────────
            ScrollView(showsIndicators: false) {
                VStack(spacing: 0) {

                    // ── Top bar (inside scroll so it scrolls away) ─────────
                    HStack {
                    ...
                    // ── Tab content (no inner ScrollView — outer scroll handles it) ──
        ...
        // ── Sticky button — always visible, content scrolls freely above it ──
    ...
    private var targetsTab: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                Muscle3DTargetsView(exercise: exercise)
