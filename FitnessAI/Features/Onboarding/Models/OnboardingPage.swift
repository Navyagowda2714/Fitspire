...
extension OnboardingPage {
    static let all: [OnboardingPage] = [
        ...
        OnboardingPage(
            ...
            bullets: ["Haptic feedback on bad form", "Correction message on wrist", "Works mid-rep in real time"]
        ),
        OnboardingPage(
        ...
        OnboardingPage(
            ...
            bullets: ["No video ever leaves your phone", "Delete your data anytime", "Cloud sync is fully optional"]
        )
    ]
}
